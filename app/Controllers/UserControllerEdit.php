...
if ( $mysqli -> multi_query($query)){
  ...
  //var_dump($datarole);
  //header('Location: http://localhost:8080/SENA6/Proyect1/app/Views/user/user.html');
}
...
<div class="container-fluid">
    ...
    <form id="form_login" action="../../app/Controllers/UserControllerUpdate.php" method="POST" onsubmit="//getData(this.id,event)">
    ...
    <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="mb-3  col-3">
                                        ...
                                        <select class="form-select"
                                            aria-label="Default select example"
                                            name="User_status_id" id="User_status_id">
                                            <option>Open this select
                                                menu</option>
                                            <?php
